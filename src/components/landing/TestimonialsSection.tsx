    ...
    <section id="testimonials" className="section-pad" style={{ position: 'relative', zIndex: 0, background: '#000000' }}>
      ...
      <div className="section-inner" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <h2 style={{ fontFamily: "'Satoshi','Satoshi','Inter',system-ui,-apple-system,sans-serif", fontWeight: 700, fontSize: 'clamp(30px,5vw,52px)', letterSpacing: '-0.025em', lineHeight: 1.05, color: '#E4E4E7', margin: '0 0 16px' }}>
            Real creators.<br />
        ...
        <div style={{ marginTop: 48, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 40, flexWrap: 'wrap' }}>
          {[
            ...
            <div key={i} style={{ textAlign: 'center' }}>
              <p style={{ fontFamily: "'Satoshi','Inter',system-ui,-apple-system,sans-serif", fontSize: 28, fontWeight: 800, color: '#D4D4D8', letterSpacing: '-0.04em', margin: '0 0 4px' }}>{s.value}</p>
