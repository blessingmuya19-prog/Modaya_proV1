    ...
    <section className="section-pad" style={{ background: 'transparent', paddingLeft: 24, paddingRight: 24 }}>
      <div className="faq-grid">
        <div style={{ marginBottom: 48 }}>
          ...
          <h2 style={{ fontFamily: "'Satoshi','Inter',system-ui,-apple-system,sans-serif", fontWeight: 700, fontSize: 'clamp(24px,4vw,40px)', letterSpacing: '-0.04em', lineHeight: 1.1, color: '#FAFAFA', margin: 0 }}>
            Common questions.
          </h2>
        </div>
