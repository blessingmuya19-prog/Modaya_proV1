  ...
  return (
    <div
      ...
      style={{
        ...
        border: `2px dashed ${dragging ? '#FAFAFA' : '#242424'}`,
        borderRadius: 16,
        background: dragging ? 'rgba(255,255,255,0.04)' : '#111111',
        display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
        textAlign: 'center', cursor: 'pointer',
        transform: dragging ? 'scale(1.01)' : 'scale(1)',
        transition: 'all 200ms ease',
        padding: 32,
        boxShadow: dragging ? 'inset 0 0 40px rgba(255,255,255,0.05)' : 'none',
      }}
    ...
    >
      ...
      <div style={{
        ...
        background: dragging ? 'rgba(255,255,255,0.15)' : '#181818',
        border: `1px solid ${dragging ? 'rgba(255,255,255,0.4)' : '#242424'}`,
        transform: dragging ? 'translateY(-4px)' : 'none',
        transition: 'all 200ms ease',
      }}>
        {dragging
          ? <Film size={24} style={{ color: '#FAFAFA' }} />
