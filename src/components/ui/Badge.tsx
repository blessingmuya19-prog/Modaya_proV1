...
const variantStyles = {
  ...
  accent:  { background: 'rgba(79,140,255,0.1)', border: '1px solid rgba(79,140,255,0.3)', color: '#4F8CFF' },
  ...
  ai:      { background: 'rgba(79,140,255,0.1)', border: '1px solid rgba(79,140,255,0.2)', color: '#4F8CFF' },
};

const dotColors = {
  default: '#666666', accent: '#4F8CFF', success: '#4ade80',
  warning: '#fbbf24', error: '#f87171', ai: '#4F8CFF',
};
