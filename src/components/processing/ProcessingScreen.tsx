      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 10, color: '#4F8CFF', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase' }}>AI is working</span>
          </div>
            ...
            return (
              <div key={step.id} style={{ display: 'flex', alignItems: 'center', gap: 16, padding: '12px 0' }}>
                ...
                <div style={{
                  ...
                  background: isDone ? '#4F8CFF' : 'transparent',
                  border: isDone ? 'none' : isActive ? '2px solid #4F8CFF' : '1px solid #242424',
                ...
                {isActive && (
                  <span style={{
                    marginLeft: 'auto', fontSize: 10, color: '#4F8CFF', fontWeight: 600,
