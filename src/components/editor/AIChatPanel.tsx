  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '12px 16px', borderBottom: '1px solid #111', display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
        <div style={{ width: 7, height: 7, borderRadius: '50%', background: '#8B5CF6', boxShadow: '0 0 6px rgba(139,92,246,0.6)' }} />
        <span style={{ fontSize: 12, fontWeight: 600, color: '#A1A1A1', letterSpacing: '-0.01em' }}>AI Assistant</span>
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(139,92,246,0.08)', border: '1px solid rgba(139,92,246,0.18)', borderRadius: 9999, padding: '2px 8px' }}>
          <span style={{ fontSize: 10, color: '#8B5CF6', fontWeight: 600 }}>v3</span>
        </div>
      </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '14px 14px 8px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        {messages.map(msg => (
          <div key={msg.id} style={{ display: 'flex', flexDirection: 'column', alignItems: msg.role === 'user' ? 'flex-end' : 'flex-start' }}>
            {msg.role === 'ai' && (
              <div style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 5, flexShrink: 0 }}>
                <span style={{ fontSize: 8, fontWeight: 700, color: '#8B5CF6' }}>AI</span>
              </div>
            )}
            <div style={{
              maxWidth: '90%', padding: '10px 13px', borderRadius: msg.role === 'user' ? '12px 12px 4px 12px' : '4px 12px 12px 12px',
              background: msg.role === 'user' ? '#8B5CF6' : '#0e0e0e',
        ...
        {isTyping && (
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
            <div style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <span style={{ fontSize: 8, fontWeight: 700, color: '#8B5CF6' }}>AI</span>
            </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              background: input.trim() && !isTyping ? '#8B5CF6' : '#141414',
